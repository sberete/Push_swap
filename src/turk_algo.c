...
/*   Updated: 2025/01/28 18:20:50 by sberete          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_cost	find_best_move_to_b(t_node *stack_a, t_node *stack_b)
{
	...
	cost.ra = cost_to_top(stack_a, stack_a->value);
	cost.rb = cost_to_top(stack_b, search_target_to_b(stack_b, stack_a->value));
...
void	best_move_application_to_b(t_stack *stack_a, t_stack *stack_b)
{
	...
	while (current)
	{
		check = find_best_move_to_b(current, stack_b->head);
